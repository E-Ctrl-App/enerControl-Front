...
export default function App() {
  ...
  if (screen === 'home') {
    return <TeacherHome onLogout={() => setScreen('login')} />;
  }
    ...
    <SafeAreaView style={styles.loginContainer}>
      ...
      <View style={styles.formCard}>
        ...
        <Pressable style={styles.secondaryButton}>
          <Text style={styles.secondaryButtonText}>Cuenta Microsoft institucional</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
...
function ClassItem({title, meta}) {
  return (
    <View style={styles.classItem}>
      <Text style={styles.classTitle}>{title}</Text>
      <Text style={styles.classMeta}>{meta}</Text>
    </View>
  );
}

function HistoryItem({title, meta, value}) {
  return (
    <View style={styles.historyItem}>
      ...
      <Text style={styles.kwh}>{value}</Text>
    </View>
  );
}
